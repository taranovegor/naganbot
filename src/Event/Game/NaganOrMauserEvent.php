...
/**
 * Class NaganOrMauserEvent
 */
class NaganOrMauserEvent extends Event
{
    public const LOADED_NAGAN = 'game.nagan_or_mauser.loaded_nagan';
    public const NOT_LOADED_NAGAN = 'game.nagan_or_mauser.not_loaded_nagan';
    public const MAUSER = 'game.nagan_or_mauser.mauser';
}
