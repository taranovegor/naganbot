...
/**
 * Class GunslingerWasNotKickedException
 */
class GunslingerWasNotKickedException extends \Exception implements ExceptionMessageInterface
{
    protected $message = 'game.gunslinger_was_not_kicked';
}
