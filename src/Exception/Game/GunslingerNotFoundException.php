...
/**
 * Class GunslingerNotFoundException
 */
class GunslingerNotFoundException extends \Exception implements ExceptionMessageInterface
{
    protected $message = 'game.gunslinger_not_found';
}
