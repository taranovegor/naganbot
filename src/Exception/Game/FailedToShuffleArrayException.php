...
/**
 * Class FailedToShuffleArrayException
 */
class FailedToShuffleArrayException extends \Exception implements ExceptionMessageInterface
{
    protected $message = 'game.failed_to_shuffle_array';
}
