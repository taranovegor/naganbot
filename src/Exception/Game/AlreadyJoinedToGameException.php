...
/**
 * Class AlreadyJoinedToGameException
 */
class AlreadyJoinedToGameException extends \Exception implements ExceptionMessageInterface
{
    protected $message = 'game.already_joined_to_game';
}
