...
use App\Telegram\Command\CreateCommand;

/**
 * Class ActiveNotFoundException
 */
class ActiveNotFoundException extends \Exception implements ParameterizedExceptionMessageInterface
{
    protected $message = 'game.active_not_found';
